                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">블랙리스트 회원 추가</h5> <button id="btn"><a href="/apa/admin/user/general/generalmain.do">돌아가기</a></button>
                                </div>
