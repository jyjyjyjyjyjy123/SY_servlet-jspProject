        ...
        <div id="content-wrapper" class="d-flex flex-column">
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">관리자 정보</h5><button id="btn"><a href="/apa/admin/info/view.do?adminId=${dto.adminId}">돌아가기</a></button>
                                </div>
			...
			<form method="POST" action="/apa/admin/user/general/edit.do">
				<table class=info>
					...
					<tr>
						<th id="id">비밀번호</th>
			            <td><input type="text" name="adminPw" class="adminPw" required class="full" value="${dto.adminPw}"></td>
					</tr>
					<tr>
						<th id="tel">연락처</th>
			            <td><input type="text" name="adminEmail" class="adminEmail" required class="full" value="${dto.adminEmail}"></td>
					</tr>
					<tr>
						<th id="email">이메일</th>
			            <td><input type="text" name="adminTel" class="adminTel" required class="full" value="${dto.adminTel}"></td>
					</tr>
				</table>
			</div>
			<div class="sbtncontainer">
				<button class="sbtn">수정완료</button>
			</div>
			</form>
